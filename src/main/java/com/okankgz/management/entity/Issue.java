...
public class Issue extends BaseEntity {
    ...
    @ManyToOne(optional = true, fetch = FetchType.LAZY)  //ıssıu classı bir tane user bağlanabilir  optional ile : assignesi vermezsende olur demek null kalasada olur , fetch : ussıue tablosuna select atılarken  User tablosundaki veri getiriksin mi EAGER  ile her zamaan getir LAZY ile istendiğinde geir
